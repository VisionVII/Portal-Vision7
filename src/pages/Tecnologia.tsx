    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-blue-600 text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-headline font-bold mb-4">Tecnologia</h1>
          <p className="text-xl opacity-90">As últimas novidades do mundo da tecnologia, inovação e ciência</p>
        </div>
      </section>
          ...
          <div className="lg:col-span-3">
            {isLoading ? (
              ...
              <div className="bg-white rounded-lg shadow-md p-8 text-center">
                ...
                <p className="text-gray-600">Estamos a trabalhar para trazer as melhores notícias de tecnologia.</p>
              </div>
            )}
          </div>
