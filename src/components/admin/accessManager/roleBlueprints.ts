...
export const ROLE_BLUEPRINTS: Array<{
...
}> = [
  {
    ...
    scope: ['Config avançadas', 'Infra & diagnósticos', 'Convites e permissões', 'Gestão completa'],
    color: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300',
  },
  {
    role: 'admin',
    title: 'Administrador',
    description: 'Opera o portal, cursos, parceiros e conteúdo.',
    scope: ['Gestão de posts', 'Newsletter e CRM', 'Cursos e parcerias'],
  ...
  },
  {
    ...
    scope: ['Publicar posts', 'Curadoria editorial', 'Revisão editorial'],
