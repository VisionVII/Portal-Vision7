    ...
    <div className="space-y-6">
      ...
      <Tabs data-tour="content-tabs" value={activeTab} onValueChange={(v) => setActiveTab(v as typeof activeTab)}>
        <TabsList className="mb-5 h-auto w-full gap-2 overflow-x-auto bg-transparent p-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <TabsTrigger value="posts" className="glass-panel gap-1.5 px-3 py-2 text-xs font-semibold data-[state=active]:border-primary/30 data-[state=active]:bg-background/70 data-[state=active]:shadow-[0_4px_16px_-4px_hsl(var(--primary)/0.4)] sm:px-4">
            <LayoutList className="w-3.5 h-3.5 shrink-0" />
            Posts editoriais
          </TabsTrigger>
          <TabsTrigger value="curated" className="glass-panel gap-1.5 px-3 py-2 text-xs font-semibold data-[state=active]:border-primary/30 data-[state=active]:bg-background/70 data-[state=active]:shadow-[0_4px_16px_-4px_hsl(var(--primary)/0.4)] sm:px-4">
          ...
          <TabsTrigger value="categories" className="glass-panel gap-1.5 px-3 py-2 text-xs font-semibold data-[state=active]:border-primary/30 data-[state=active]:bg-background/70 data-[state=active]:shadow-[0_4px_16px_-4px_hsl(var(--primary)/0.4)] sm:px-4">
